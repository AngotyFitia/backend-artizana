...
public class Produit {
    ...
    public Produit insert(Connection con)throws Exception{
        ...
        try{
            ...
            String sql="INSERT INTO PRODUIT VALUES(DEFAULT,"+this.getCategorie().getIdCategorie()+","+this.getSociete().getIdSociete()+",'"+this.getIntitule()+"',  1) returning id_produit";
            System.out.println(sql);
            res=stmt.executeQuery(sql);
            if(res.next()) this.setIdProduit(res.getInt("id_produit"));
    ...
    public void update(Connection con)throws Exception{
        ...
        try{
            ...
            stmt= con.createStatement();
            String sql="UPDATE produit SET intitule='"+this.getIntitule()+"' WHERE id_produit="+this.getIdProduit();
            System.out.println(sql);
